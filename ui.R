...
shinyUI(fluidPage(title="ABCpred: A web server for the discovery of acetyl- and butyryl-cholinesterase inhibitors", theme=shinytheme("united"),
                  useShinyjs(),
                  navbarPage(strong("Drugs4BC"), collapsible = TRUE,
                             titleContent <- HTML("<b>ABCpred</b>: A web server for the discovery of acetyl- and butyryl-cholinesterase inhibitors"),
